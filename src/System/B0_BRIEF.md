# B0 brief: the eight steps in one worker

Provenance: written 2026-09-14 for `docs/PLAN.md` task 9.5 from
`SYSTEM.md`, `STEPS.md` and `TECHNIQUES.md`. This is the single-model
