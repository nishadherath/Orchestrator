...
description: Sonnet at max effort. Not in the routing table; use only on a documented escalation (ROUTING.md section 4). Select by subagent_type only; never pass a model parameter.
model: sonnet
effort: max
---
