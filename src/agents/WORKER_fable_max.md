...
description: Fable at max effort. Routed for: frontier problem where every cheaper cell has already failed. Select by subagent_type only; never pass a model parameter.
model: fable
effort: max
---
