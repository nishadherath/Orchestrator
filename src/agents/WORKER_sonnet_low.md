...
description: Sonnet at low effort. Routed for: mechanical, structured or open, short, contained; mechanical or open, long horizon, contained. Select by subagent_type only; never pass a model parameter.
model: sonnet
effort: low
---
