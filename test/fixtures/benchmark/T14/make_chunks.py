#!/usr/bin/env python3
"""Writes chunk-01.txt through chunk-06.txt: 350 numbered lines of ten
words each, drawn from a small set of everyday nouns, deterministic
from a fixed seed. Six files rather than five, so five can actually be
read while one is deliberately skipped.
