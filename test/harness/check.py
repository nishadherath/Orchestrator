...
def check_system_controller(r: Report) -> None:
    """SYSTEM: tools/system_controller.py's --selftest passes: nine scripted
    ...
    reframe cap, reframed-continues, self-chosen-id remap), no claude -p
    calls (docs/PLAN.md Stage 10.6; scenarios 0, 7 and 8 added after three
    live toy runs in Stage 10.9 found real bugs)."""
