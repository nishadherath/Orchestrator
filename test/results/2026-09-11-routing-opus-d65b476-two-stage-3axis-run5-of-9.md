# Routing score, reporting, two-stage, 3 axes (run 5 of 9) 2026-09-11 17:12 at 594810a
...
All fields agree 13/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 15/17. Cost reported by claude: USD 1.6613.
...
| F07 | structured/long/contained; self_directed=False; prior_failure=none | mechanical/long/contained; self_directed=False; prior_failure=none | 4/5 | no | assessment: mechanical, long, contained; self_directed: false; prior_failure: none |
...
| F14 | open/long/consequential; self_directed=False; prior_failure=failed_at_xhigh | open/medium/consequential; self_directed=False; prior_failure=failed_at_xhigh | 4/5 | yes | assessment: open, medium, consequential; self_directed: false; prior_failure: failed_at_xhigh |
