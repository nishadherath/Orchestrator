# Routing score, steering, two-stage, 3 axes (run 3 of 3) 2026-09-11 15:59 at d3371ca
...
All fields agree 13/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 15/17. Cost reported by claude: USD 1.5163.
