# Routing score, reporting, two-stage, 3 axes (run 4 of 9) 2026-09-11 17:35 at 594810a
...
All fields agree 8/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 9/17. Cost reported by claude: USD 0.1623.
...
| F07 | structured/long/contained; self_directed=False; prior_failure=none | mechanical/long/consequential; self_directed=True; prior_failure=none | 2/5 | no | assessment: mechanical, long, consequential; self_directed: true; prior_failure: none |
...
| F12 | open/long/consequential; self_directed=False; prior_failure=none | structured/long/consequential; self_directed=True; prior_failure=none | 3/5 | no | assessment: structured, long, consequential; self_directed: true; prior_failure: none |
