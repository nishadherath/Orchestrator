# Routing score, reporting, two-stage, 3 axes (run 8 of 9) 2026-09-11 17:42 at 594810a
...
All fields agree 8/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 11/17. Cost reported by claude: USD 0.1622.
...
| F10 | open/medium/contained; self_directed=False; prior_failure=none | open/medium/contained; self_directed=True; prior_failure=none | 4/5 | yes | assessment: open, medium, contained; self_directed: true; prior_failure: none |
