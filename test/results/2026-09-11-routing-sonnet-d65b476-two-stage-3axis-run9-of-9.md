# Routing score, reporting, two-stage, 3 axes (run 9 of 9) 2026-09-11 17:44 at 594810a
...
All fields agree 9/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 11/17. Cost reported by claude: USD 0.1623.
...
| F03 | mechanical/medium/contained; self_directed=False; prior_failure=none | mechanical/long/contained; self_directed=True; prior_failure=none | 3/5 | no | assessment: mechanical, long, contained; self_directed: true; prior_failure: none |
