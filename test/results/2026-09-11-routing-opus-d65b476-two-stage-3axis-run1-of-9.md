# Routing score, reporting, two-stage, 3 axes (run 1 of 9) 2026-09-11 16:57 at 594810a
...
All fields agree 14/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 15/17. Cost reported by claude: USD 1.9200.
...
| F14 | open/long/consequential; self_directed=False; prior_failure=failed_at_xhigh | open/long/consequential; self_directed=False; prior_failure=failed_at_xhigh | 5/5 | yes | assessment: open, long, consequential; self_directed: false; prior_failure: failed_at_xhigh |
