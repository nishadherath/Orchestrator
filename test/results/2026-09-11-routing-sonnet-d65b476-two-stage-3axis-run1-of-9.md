# Routing score, reporting, two-stage, 3 axes (run 1 of 9) 2026-09-11 17:30 at 594810a
...
All fields agree 9/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 11/17. Cost reported by claude: USD 0.6262.
