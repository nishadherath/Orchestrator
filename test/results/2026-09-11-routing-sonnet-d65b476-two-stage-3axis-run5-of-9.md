# Routing score, reporting, two-stage, 3 axes (run 5 of 9) 2026-09-11 17:37 at 594810a
...
All fields agree 6/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 8/17. Cost reported by claude: USD 0.1413.
...
| F03 | mechanical/medium/contained; self_directed=False; prior_failure=none | [unparsed] |  |  | assessment: mechanical, long; contained; self_directed: false; prior_failure: none |
...
| F08 | structured/medium/consequential; self_directed=False; prior_failure=none | structured/long/consequential; self_directed=False; prior_failure=none | 4/5 | no | assessment: structured, long, consequential; self_directed: false; prior_failure: none |
