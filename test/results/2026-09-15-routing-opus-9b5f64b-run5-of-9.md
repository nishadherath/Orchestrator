# Routing score, reporting (run 5 of 9) 2026-09-15 08:36 at 6c05fa8

Orchestrator model: opus. Bundle: 2026-09-15-9b5f64b. Project: `C:\Users\Bob\Desktop\Code\Claude\orchestrator-scratch`. Fixtures reviewed by a human: yes. Mode: assess and select.

Grade: reporting (at or above 9 runs).

Agreement 18/18. Over-provisioned 0, under-provisioned 0, unparsed 0. Cost reported by claude: USD 4.0629.
...
| F07 | worker-sonnet-low | worker-sonnet-low | yes | 2/3 | exact | assessment: mechanical, long, contained; worker: worker-sonnet-low; action: spawn |
...
| F09 | worker-sonnet-low | worker-sonnet-low | yes | 2/3 | exact | assessment: open, medium, contained; worker: worker-sonnet-low; action: spawn |
| F10 | worker-sonnet-low | worker-sonnet-low | yes | 3/3 | exact | assessment: open, medium, contained; worker: worker-sonnet-low; action: spawn |
| F11 | worker-sonnet-low | worker-sonnet-low | yes | 2/3 | exact | assessment: open, medium, consequential; worker: worker-sonnet-low; action: spawn |
| F12 | worker-sonnet-low | worker-sonnet-low | yes | 3/3 | exact | assessment: open, long, consequential; worker: worker-sonnet-low; action: spawn |
...
| F14 | worker-opus-max | worker-opus-max | yes | 2/3 | exact | assessment: open, long, contained; worker: worker-opus-max; action: spawn |
...
| F16 | [clarify] | [clarify] | yes |  | n/a | assessment: open, long, contained; worker: none; action: clarify |
...
| F18 | worker-sonnet-low | worker-sonnet-low | yes | 3/3 | exact | assessment: open, long, consequential; worker: worker-sonnet-low; action: spawn |
