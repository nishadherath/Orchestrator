# Routing score, reporting, two-stage, 3 axes (run 7 of 9) 2026-09-11 17:40 at 594810a
...
All fields agree 8/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 10/17. Cost reported by claude: USD 0.1624.
