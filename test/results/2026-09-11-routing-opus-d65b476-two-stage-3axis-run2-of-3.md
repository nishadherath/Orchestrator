# Routing score, steering, two-stage, 3 axes (run 2 of 3) 2026-09-11 15:55 at d3371ca
...
All fields agree 13/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 15/17. Cost reported by claude: USD 1.4557.
...
| F05 | structured/medium/contained; self_directed=False; prior_failure=none | structured/medium/contained; self_directed=True; prior_failure=none | 4/5 | yes | assessment: structured, medium, contained; self_directed: true; prior_failure: none |
...
| F07 | structured/long/contained; self_directed=False; prior_failure=none | mechanical/long/consequential; self_directed=False; prior_failure=none | 3/5 | no | assessment: mechanical, long, consequential; self_directed: false; prior_failure: none |
...
| F09 | open/short/contained; self_directed=False; prior_failure=none | open/short/contained; self_directed=False; prior_failure=none | 5/5 | yes | assessment: open, short, contained; self_directed: false; prior_failure: none |
