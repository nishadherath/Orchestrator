# Routing score, reporting (run 7 of 9) 2026-09-11 12:44 at 36d87fe
...
Agreement 18/18. Over-provisioned 1, under-provisioned 0, unparsed 0. Cost reported by claude: USD 1.6511.
...
| F09 | worker-sonnet-low | worker-sonnet-low | yes | 3/3 | exact | Reviewing a PR for correctness risk in a retry policy: open (judgement about what's correct, wrong answer expensive later), short horizon (200 lines, no code changes, under ten tool calls), and contai |
