# Routing score 2026-09-05 17:14 at 3f753db

Orchestrator model: sonnet. Bundle: 2026-09-05-1708054. Project: `C:\Users\Bob\Desktop\Code\Claude\orchestrator-scratch`. Fixtures reviewed by a human: yes.

Agreement 11/17. Over-provisioned 0, under-provisioned 4, unparsed 0. Cost reported by claude: USD 0.7623.
...
| F05 | worker-sonnet-medium | worker-sonnet-low | no | 1/3 | under | assessment: mechanical, short, contained; worker: worker-sonnet-low; action: spawn |
...
| F10 | worker-opus-high | worker-opus-high | no | 3/3 | exact | assessment: open, medium, contained; worker: worker-opus-high; action: clarify |
...
| F13 | worker-fable-xhigh | worker-opus-xhigh | no | 2/3 | under | assessment: open, long, consequential; worker: worker-opus-xhigh; action: clarify |
...
| F16 | [clarify] | [clarify] | yes |  | n/a | assessment: open, short, consequential; worker: none; action: clarify |
