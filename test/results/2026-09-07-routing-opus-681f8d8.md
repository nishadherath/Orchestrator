# Routing score 2026-09-07 18:44 at ef2dc86

Orchestrator model: opus. Bundle: 2026-09-07-681f8d8. Project: `C:\Users\Bob\Desktop\Code\Claude\orchestrator-scratch`. Fixtures reviewed by a human: yes. Mode: assess and select.

Agreement 14/19. Over-provisioned 5, under-provisioned 1, unparsed 0. Cost reported by claude: USD 3.6546.
...
| F07 | worker-sonnet-xhigh | worker-sonnet-xhigh | yes | 3/3 | exact | assessment: structured, long, contained; worker: worker-sonnet-xhigh; action: spawn |
...
| F11 | worker-opus-xhigh | worker-fable-xhigh | no | 2/3 | over | assessment: open, long, consequential; worker: worker-fable-xhigh; action: spawn |
...
| F19 | worker-sonnet-low | worker-sonnet-medium | no | 2/3 | over | assessment: mechanical, medium, contained; worker: worker-sonnet-medium; action: spawn |
