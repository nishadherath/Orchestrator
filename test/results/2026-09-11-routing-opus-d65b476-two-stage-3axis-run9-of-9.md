# Routing score, reporting, two-stage, 3 axes (run 9 of 9) 2026-09-11 17:27 at 594810a
...
All fields agree 13/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 16/17. Cost reported by claude: USD 1.5859.
...
| F11 | open/long/consequential; self_directed=False; prior_failure=none | open/medium/consequential; self_directed=False; prior_failure=none | 4/5 | yes | assessment: open, medium, consequential; self_directed: false; prior_failure: none |
