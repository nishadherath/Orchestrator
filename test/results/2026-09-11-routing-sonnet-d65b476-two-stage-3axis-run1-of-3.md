# Routing score, steering, two-stage, 3 axes (run 1 of 3) 2026-09-11 16:09 at d3371ca
...
All fields agree 7/17 (the primary metric, per docs/CLASSIFIER-DESIGN.md: cell agreement forgives up to a third of single-field errors, docs/PREMISES.md). Cell agreement (derived via tools/route.py) 9/17. Cost reported by claude: USD 0.6527.
...
| F04 | structured/short/contained; self_directed=False; prior_failure=none | structured/medium/contained; self_directed=False; prior_failure=none | 4/5 | no | assessment: structured, medium, contained; self_directed: false; prior_failure: none |
