...
description: Fable at xhigh effort. Not in the routing table; use only on a documented escalation (ROUTING.md section 2). Select by subagent_type only; never pass a model parameter.
model: fable
effort: xhigh
---
